...
# Directories
cfg.DATA_DIRECTORY_SOURCE = str(project_root / '../data/GTAV')
...
# TRAIN CONFIGS
cfg.TRAIN = EasyDict()
cfg.TRAIN.SOURCE_CSV = str(project_root / 'advent/dataset/gta5.csv')
cfg.TRAIN.TARGET_CSV = str(project_root / 'advent/dataset/cityscapes.csv')
...
cfg.TRAIN.IMG_MEAN = np.array((122.67891434, 116.66876762, 104.00698793), dtype=np.float32)
...
# Consistency params
cfg.TRAIN.LAMBDA_SEG_KL_CT = 0.001
cfg.TRAIN.LAMBDA_SEG_KL_SEM = 0.001
cfg.TRAIN.LAMBDA_SEG_KL_HIST = 0.001
...
#Curriculum 
cfg.TRAIN.INCLUDE_NEW = 25000
cfg.TRAIN.PACING = ""
cfg.TRAIN.CLASSES_INCLUDE = 3
cfg.TRAIN.WEIGHTS = False 
cfg.TRAIN.PREV_STOP = 0
cfg.TRAIN.ORDER = ""
# TEST CONFIGS
cfg.TEST = EasyDict()
...
cfg.TEST.IMG_MEAN =  np.array((122.67891434, 116.66876762, 104.00698793), dtype=np.float32)#np.array((104.00698793, 116.66876762, 122.67891434), dtype=np.float32)
...
cfg.TEST.FLIP = False
cfg.TEST.LAMBDA_MAIN = 1.0
cfg.TEST.LAMBDA_AUX = 0.0
